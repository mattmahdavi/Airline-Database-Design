create database FinalProjectSQL;
Use FinalProjectSQL;
...
('F001', 'AA001', 'AA', 'LAX', '2023-04-20 10:00:00', 'JFK', '2023-04-20 18:00:00', '08:00', 200, 250.00),

('F002', 'AA002', 'AA', 'JFK', '2023-04-21 08:00:00', 'LAX', '2023-04-21 16:00:00', '08:00', 200, 225.00),

('F003', 'UA001', 'UA', 'ORD', '2023-04-22 12:00:00', 'DFW', '2023-04-22 15:00:00', '03:00', 150, 125.00),

('F004', 'UA002', 'UA', 'DFW', '2023-04-23 07:00:00', 'ORD', '2023-04-23 10:00:00', '03:00', 150, 135.00),

('F005', 'DL001', 'DL', 'DEN', '2023-04-24 16:00:00', 'LAS', '2023-04-24 19:00:00', '05:00', 175, 175.00),

('F006', 'DL002', 'DL', 'LAS', '2023-04-25 11:00:00', 'DEN', '2023-04-25 17:00:00', '06:00', 200, 300.00),

('F007', 'WN001', 'SW', 'ATL', '2023-04-26 09:00:00', 'SEA', '2023-04-26 12:00:00', '03:00', 150, 95.00),

('F008', 'WN002', 'SW', 'SEA', '2023-04-27 14:00:00', 'ATL', '2023-04-27 17:00:00', '03:00', 150, 85.00),

('F009', 'AS001', 'AS', 'MIA', '2023-04-28 10:00:00', 'SFO', '2023-04-28 16:00:00', '06:00', 175, 250.00),

('F010', 'AS002', 'AS', 'BOS', '2023-04-29 12:00:00', 'IAH', '2023-04-29 18:00:00', '06:00', 175, 225.00),

('F011', 'B6H001', 'JB', 'IAH', '2023-04-30 08:00:00', 'BOS', '2023-04-30 10:00:00', '02:00', 100, 75.00),

('F012', 'DL003', 'DL', 'DCA', '2023-04-22 09:00:00', 'PHX', '2023-04-22 17:00:00', '08:00', 180, 215.00),

('F013', 'DL004', 'DL', 'PHX', '2023-04-23 07:00:00', 'DCA', '2023-04-23 15:00:00', '08:00', 180, 199.00),

('F014', 'UA005', 'UA', 'ORD', '2023-04-24 11:00:00', 'LAX', '2023-04-24 14:00:00', '03:00', 250, 300.00),

('F015', 'UA006', 'UA', 'LAX', '2023-04-25 12:00:00', 'ORD', '2023-04-25 15:00:00', '03:00', 250, 275.00),

('F016', 'WN007', 'SW', 'LGA', '2023-04-26 08:00:00', 'TPA', '2023-04-26 09:00:00', '01:00', 150, 150.00),

('F017', 'WN008', 'SW', 'TPA', '2023-04-27 09:00:00', 'LGA', '2023-04-27 10:00:00', '01:00', 150, 140.00),

('F018', 'AS009', 'AS', 'SEA', '2023-04-28 13:00:00', 'LAX', '2023-04-28 15:00:00', '02:00', 200, 225.00),

('F019', 'AS010', 'AS', 'LAX', '2023-04-29 14:00:00', 'SEA', '2023-04-29 16:00:00', '02:00', 200, 235.00),

('F020', 'B6B011', 'JB', 'BOS', '2023-04-30 09:00:00', 'JFK', '2023-04-30 10:00:00', '01:00', 100, 95.00)
...
('C023', 'Hemant', 'Pahuja', '972-555-9999', NULL, 'h.p@example.com', 'Passport', '123456789', '1980-05-20', 'Male', 'American', 'C022'),


('C001', 'John', 'Doe', '972-555-1234', NULL, 'john.doe@example.com', 'Passport', '123456789', '1990-05-20', 'Male', 'American', 'C002'),

('C002', 'Jane', 'Smith', '972-555-5678', NULL, 'jane.smith@example.com', 'National ID', '987654321', '1995-07-15', 'Female', 'British','C002'),

('C003', 'Bob', 'Johnson', '972-555-9876', NULL, 'bob.johnson@example.com', 'Driver License', '456789123', '1985-02-28', 'Male', 'Canadian',  'C004'),

('C004', 'Sarah', 'Lee', '972-555-2345', '972-555-6789', 'sarah.lee@example.com', 'Passport', '789123456', '2000-09-10', 'Female', 'Korean',  'C001'),

('C005', 'David', 'Kim', '972-555-8765', NULL, 'david.kim@example.com', 'National ID', '654123789', '1998-11-30', 'Male', 'Korean',  'C005'),

('C006', 'Mary', 'Jones', '972-555-3456', NULL, 'mary.jones@example.com', 'Driver License', '321987654', '1975-06-03', 'Female', 'American',  'C006'),

('C007', 'Tom', 'Brown', '972-555-6543', NULL, 'tom.brown@example.com', 'Passport', '369852147', '1993-04-12', 'Male', 'British',  'C008'),

('C008', 'Kate', 'Wong', '972-555-7890', '972-555-4567', 'kate.wong@example.com', 'National ID', '258741369', '1988-08-08', 'Female', 'Chinese',  'C008'),

('C009', 'Michael', 'Chen', '972-555-4321', NULL, 'michael.chen@example.com', 'Driver License', '741852963', '1996-01-25', 'Male', 'Chinese',  'C001'),

('C010', 'Samantha', 'Garcia', '972-555-8901', NULL, 'samantha.garcia@example.com', 'Passport', '159357246', '1992-12-20', 'Female', 'Mexican',  'C006'),

('C011', 'Daniel', 'Rodriguez', '972-555-6789', NULL, 'daniel.rodriguez@example.com', 'National ID', '357159864', '1980-09-08', 'Male', 'Mexican',  'C012'),

('C012', 'Emily', 'Nguyen', '972-555-2345', NULL, 'emily.nguyen@example.com', 'National ID', '123789456', '1997-03-15', 'Female', 'Vietnamese', 'C012'),

('C013', 'Aiden', 'Wilson', '972-555-8765', NULL, 'aiden.wilson@example.com', 'Driver License', '258963147', '1983-08-20', 'Male', 'American',  'C013'),

('C014', 'Olivia', 'Garcia', '972-555-3456', NULL, 'olivia.garcia@example.com', 'Passport', '753951486', '2001-05-03', 'Female', 'Mexican',  'C014'),

('C015', 'James', 'Kwok', '972-555-6543', NULL, 'james.kwok@example.com', 'National ID', '951753864', '1994-11-18', 'Male', 'Hong Kong',  'C019'),

('C016', 'Isabella', 'Cheung', '972-555-7890', NULL, 'isabella.cheung@example.com', 'Driver License', '369874125', '1992-01-01', 'Female', 'Hong Kong',  'C016'),

('C017', 'Ethan', 'Singh', '972-555-4321', '972-555-5678', 'ethan.singh@example.com', 'Passport', '852963741', '1999-07-10', 'Male', 'Indian',  'C021'),

('C018', 'Aria', 'Patel', '972-555-6789', NULL, 'aria.patel@example.com', 'National ID', '456321789', '1989-12-25', 'Female', 'Indian', 'C018'),

('C019', 'Lucas', 'Lee', '972-555-2345', '972-555-6789', 'lucas.lee@example.com', 'Driver License', '654789321', '1986-04-05', 'Male', 'Korean',  'C019'),

('C020', 'Mia', 'Kim', '972-555-9876', NULL, 'mia.kim@example.com', 'Passport', '987654321', '1998-02-12', 'Female', 'Korean',  'C020'),

('C021', 'Daniel', 'Nguyen', '972-555-3456', NULL, 'daniel.nguyen@example.com', 'National ID', '456123789', '1980-09-08', 'Male', 'Vietnamese',  'C019'),

('C022', 'Sophia', 'Tran', '972-555-6543', '972-555-7890', 'sophia.tran@example.com', 'Driver License', '123456789', '1995-06-28', 'Female', 'Vietnamese',  'C022'); 
...
INSERT INTO Payment (PaymentID, CustID, AddressID, CustFirstName, CustLastName, CardType, CardNumber, CVV, ExpirationDate, BillingZipCode)
